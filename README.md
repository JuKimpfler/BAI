...
- **Epsilon-Schedule:** Definiert den Explorationsverlauf im DQN-Training als **durch Zeilenumbrüche getrennte** Einträge `Trainingsfortschritt in %:Epsilon-Wert`, z. B.:
  ```text
  0:1.0
  50:0.5
  100:0.02
